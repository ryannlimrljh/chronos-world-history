...
export const POLITY_ZH: Record<string, string> = {
  ...
  'kara-khitan': '西辽',
  'dzungar': '准噶尔汗国',
  'uzbek-khanates': '布哈拉与希瓦汗国',
  'visigoths': '西哥特王国',
  'lombards': '伦巴第王国',
  'norse-kingdoms': '北欧诸王国',
  'kalmar': '卡尔马联盟',
  'sweden': '瑞典',
  'normans-sicily': '西西里诺曼王国',
  'bulgarian-empire': '保加利亚帝国',
  'serbian-empire': '塞尔维亚帝国',
  'bohemia': '波希米亚王国',
  'teutonic-order': '条顿骑士团国',
  'austria-hungary': '奥匈帝国',
  'prussia': '普鲁士王国',
  'czechoslovakia': '捷克斯洛伐克',
  'yugoslavia': '南斯拉夫',
  'pallava-chalukya': '帕拉瓦与遮娄其',
  'rashtrakuta': '拉施特拉库塔王朝',
  'pala': '波罗王朝',
  'bengal-sultanate': '孟加拉苏丹国',
  'sikh-empire': '锡克帝国',
  'champa': '占婆',
  'lan-xang': '澜沧王国',
  'toungoo-konbaung': '东吁与贡榜缅甸',
  'philippines': '菲律宾',
  'carthage-numidia': '努米底亚与毛里塔尼亚',
  'hafsid': '哈夫斯与扎亚尼王朝',
  'nok': '诺克文化',
  'swahili-coast': '斯瓦希里城邦',
  'oyo': '奥约帝国',
  'buganda': '布干达',
  'funj-sennar': '芬吉苏丹国',
  'zulu': '祖鲁王国',
  ...
  'toltec': '托尔特克',
  'chimu': '奇穆王国',
  'haudenosaunee': '豪德诺索尼联盟',
  'brazil': '巴西',
  'mexico': '墨西哥',
  'canada': '加拿大',
  'gran-colombia': '大哥伦比亚与安第斯诸共和国',
  'argentina-chile': '阿根廷与智利',
  'fiji-samoa': '斐济与萨摩亚酋邦',
  'new-guinea': '新几内亚高地社会',
  'new-zealand': '新西兰',
  'ireland': '爱尔兰',
